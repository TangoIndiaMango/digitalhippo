...
import { Html, Head, Preview, Body, Container, Column, Hr, Row, Img, Link, Section, Text, render } from "@react-email/components";
...
const RecieptEmail = ({ email, date, orderId, products }: Props) => {
...
export const ReceiptEmailHtml = (props: Props) => render(<RecieptEmail {...props} />, {
    pretty: true,
})