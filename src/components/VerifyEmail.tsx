...
const VerifyEmail = ({ token }: Props) => {
    ...
    if (data?.success) {
        ...
        return (
            <div className='flex h-full flex-col items-center justif-center'>
                <div className='relative mb-4 h-60 w-60 text-muted-foreground'>
                    <Image src='/hippo-email-sent.png' fill alt='The email was sent' />
                </div>

                <h3 className='font-semibold text-2xl'>You&apos;re all set</h3>
                <p className='text-muted-foreground text-center mt-1'>Your email is now verified. Thank you.</p>
