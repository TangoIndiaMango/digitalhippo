                    ...
                    <div className='lg:max-w-lg lg:self-end'>
                        ...
                        <section className='mt-4'>
                            <div className='flex items-center'>
                                ...
                                <div className='ml-4 border-l text-muted-foreground boreder-gray-300 pl-4'>{label}</div>
                            </div>
                            ...
                            <div className='mt-6 flex items-center'>
                                ...
                                <p className='ml-2 text-sm text-gray-500'>Eligieble for instant delivery</p>
                            </div>
                        </section>
                    </div>
