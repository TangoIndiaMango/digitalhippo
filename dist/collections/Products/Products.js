                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            updated = __assign(__assign({}, data), { stripId: createProduct.id, priceId: createProduct.default_price });
                        ...
                        case 3:
                            ...
                            updated = __assign(__assign({}, data), { stripId: updateProduct.id, priceId: updateProduct.default_price });
                            return [2 /*return*/, updated];
    ...
    fields: [
        {
            ...
            hasMany: false,
            admin: {
                condition: function () { return false; } //the product wont be available on admin dashboard
            },
        },
        {
            name: "name",
