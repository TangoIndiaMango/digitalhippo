...
var addUser = function (_a) {
    ...
    var user = req.user;
    return __assign(__assign({}, data), { users: user === null || user === void 0 ? void 0 : user.id });
};
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProductFileIds = products.map(function (prod) { return prod.product_files; }).flat() //make sure it's an array for the ids of a product file
                    ;
                    return [4 /*yield*/, req.payload.find({
                            collection: "orders",
                ...
                case 2:
                    ...
                    purchasedProductFileIds = orders.map(function (order) {
                        return order.product.map(function (prod) {
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFileIds, true), purchasedProductFileIds, true) //combine the two arrays of ids] if what you need is in the array it'll return to you
                            }
                        }];
            }
        });
