...
var accountCredentialsValidators_1 = require("../lib/validators/accountCredentialsValidators");
var server_1 = require("@trpc/server");
var zod_1 = require("zod");
exports.authRouter = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure.input(accountCredentialsValidators_1.AuthCreditentialsValidation).mutation(function (_a) {
        var input = _a.input;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { success: true, message: "Email verified" }];
                }
            });
        });
    }),
    ...
    signIn: trpc_1.publicProcedure.input(accountCredentialsValidators_1.AuthCreditentialsValidation).mutation(function (_a) {
