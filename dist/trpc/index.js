...
var queryValidators_1 = require("../lib/validators/queryValidators");
var getPayload_1 = require("../getPayload");
var payment_router_1 = require("./payment-router");
exports.appRouter = (0, trpc_1.router)({
    auth: auth_router_1.authRouter,
    paymnet: payment_router_1.paymentRouter,
    getInfiniteProduct: trpc_1.publicProcedure.input(zod_1.z.object({
        limit: zod_1.z.number().min(1).max(100),
        cursor: zod_1.z.number().nullish(), //last element rendered, begin fetching next page
        query: queryValidators_1.QueryValidators
    })).query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, limit, sort, queryOpts, payload, parsedQueryOpt, page, _b, items, hasNextPage, nextPage;
